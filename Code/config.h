...
const int MUX_S1_PIN = 8;
const int MUX_S2_PIN = 3;
const int MUX_S3_PIN = 1;
const uint8_t MUX_CHANNEL_MIN = 0;
const uint8_t MUX_CHANNEL_MAX = 15;
...
#define WAVE_MITBIH_MLII   WAVE_CUSTOM2
#define WAVE_EEG_OPEN      WAVE_CUSTOM3
#define WAVE_EEG_CLOSED    WAVE_CUSTOM4
#define WAVE_EMG_HEALTHY   WAVE_CUSTOM5
#define WAVE_FLATLINE_25V  WAVE_CUSTOM6

inline bool waveformUsesRealDataTable(WaveformType wf) {
  return (wf == WAVE_MITBIH_MLII) ||
         (wf == WAVE_EEG_OPEN) ||
         (wf == WAVE_EEG_CLOSED) ||
         (wf == WAVE_EMG_HEALTHY) ||
         (wf == WAVE_FLATLINE_25V);
}

inline bool waveformUsesPlaybackFactor(WaveformType wf) {
  return waveformUsesRealDataTable(wf);
}
...
extern uint8_t selectedMuxChannel;
